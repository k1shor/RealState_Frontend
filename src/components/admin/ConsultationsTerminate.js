...
const ConsultationTerminate = ({ match }) => {
    ...
    const redirectTo = () => {
        if (redirect) {
            ...
            return <Redirect to={`/admin/consultation/terminated`} />
        ...
        <div className='container w-50 shadow-lg p-5'>
            <main className="form-signin">
                ...
                <form>
                    ...
                    <button className='btn btn-info w-50' onClick={clickSubmit}>Cancel Consultation</button>
...
export default ConsultationTerminate;
