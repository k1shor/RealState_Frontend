...
const BookingSuccess = () => {
    ...
    return (
        <>
            <Nav />
            <div className='text-center h4 text-success'>Contract Submitted Successfully. You will be notified about your contract soon. Meanwhile you can view other listings.</div>
            <div className='text-center mt-5'>
            <Link to="/recent"><h3>Recent Listings</h3></Link></div>
